...
4.  寻找 PayPal 按钮![images](images/U001.jpg)管理我的支付按钮。单击最右侧的相关更新链接。
...
![images](images/square.jpg) **注意**将每个按钮的代码粘贴到记事本等文本编辑器中。用容易识别的名称保存。这是一个安全预防措施，以防你弄乱了网页，不得不重新开始。你不会想要从头再下载所有按钮的麻烦。

##### 在页面中嵌入 PayPal 按钮

![images](images/square.jpg) **提示**我建议你先练习使用默认按钮。熟悉 PayPal 界面后，尝试更复杂的按钮。请记住，您可以通过创建按钮、嵌入按钮、然后删除按钮来练习。
...
![images](images/square.jpg) **注**[图 10-1](#fig_10_1) 中的截图是离线创建的；因此，PayPal 按钮尚不可见。

![images](images/9781430242758_Fig10-01.jpg)
...
![images](images/9781430242758_Fig10-02.jpg)
...
![images](images/square.jpg) **注意**出于安全原因，本例中的 PayPal 代码块被故意改动。下载的 PayPal 代码以粗体显示。
...
<p class="cntr"><br><img alt="" src="images/valid-html401.png" width="88" ![images](images/U002.jpg)
height="31"><br><span class="tiny">Validated by the<br>World Wide Web<br>![images](images/U002.jpg)
Consortium</span></p>
<p class="cntr redarrow"><a href="#top"><img  title="Go to top of page" ![images](images/U002.jpg)
src="images/upred.gif" alt="Go to top of page" width="33" height="30"></a><br>![images](images/U002.jpg)
<b>Go to top of page</b></p>
</div><!--end of right column-->
<div class="box"><!--CREATE FIRST BOX-->
<h2 class="cntr">Pay by PayPal OR Credit/Debit Card</h2>
<img src="images/debitcards.gif" alt="Cards" title="Cards" width="149" height="16"><br>
...
        <br>Click <b>View Cart</b> to correct mistakes, alter quantities, continue ![images](images/U002.jpg)
        shopping, go to checkout
**</form>**
</div>
<div class="box"><!--CREATE SECOND BOX-->
<img title="Beach" alt="Beach" height="95" src="images/beach2thumb.jpg" style="float: left; ![images](images/U002.jpg)
margin-left: 5px; margin-right: 5px" width="77"><b>Pack of 5 cards for &pound;4.50 ![images](images/U002.jpg)
(free UK delivery)</b>
**<form target="paypal" action="https://www.paypal.com/cgi-bin/webscr" method="post">**
...
**<input type="image" src="https://www.paypal.com/en_GB/i/btn/btn_cart_LG.gif" ![images](images/U002.jpg)** **name="submit" alt="PayPal - The safer, easier way to pay online.">**
**<img alt="" src="https://www.paypal.com/en_GB/i/scr/pixel.gif" width="1" height="1">**
**</form>**
</div>
<div class="box"><!--THIRD BOX-->
<img title="Sir Patrick Moore's cat" alt="Sir Patrick Moore's cat" height="91"
src="images/catthumb.jpg" style="float: left; margin-left: 5px; margin-right: 5px" ![images](images/U002.jpg)
width="69" /><b>Pack of 5 cards for &pound;4.50 (free UK delivery)</b>![images](images/U002.jpg)
**<form target="paypal" action="https://www.paypal.com/cgi-bin/webscr" method="post">**
**<input type="hidden" name="cmd" value="_s-xclick">**
...
**</select>&nbsp; inclusive price per pack of five cards</p>**
**<input type="hidden" name="currency_code" value="GBP">**
**<input type="image" src="https://www.paypal.com/en_GB/i/btn/btn_cart_LG.gif"** ![images](images/U002.jpg)
**name="submit" alt="PayPal - The safer, easier way to pay online.">**
**<img alt="" src="https://www.paypal.com/en_GB/i/scr/pixel.gif" width="1" height="1">**
**</form>**
</div>
<div class="box-bottom"><!--FOURTH BOX-->
<img title="Ferns and Flowers" alt="Ferns and Flowers" height="103" ![images](images/U002.jpg)
src="images/fernsthumb.jpg" style="float: left; margin-left: 5px; margin-right: 5px" ![images](images/U002.jpg)
width="73">
<b>Pack of 5 cards for &pound;4.50 (free UK delivery)</b> ![images](images/U002.jpg)
**<form target="paypal" action="https://www.paypal.com/cgi-bin/webscr" method="post">**
**<input type="hidden" name="cmd" value="_s-xclick">**
...
**        <option value="Outside Europe">Outside Europe &pound;7.20</option>**
**</select>&nbsp; inclusive price per pack of five cards</p>**
**<input type="hidden" name="currency_code" value="GBP" />**` `**<input type="image" src="https://www.paypal.com/en_GB/i/btn/btn_cart_LG.gif"** ![images](images/U002.jpg)
**name="submit" alt="PayPal - The safer, easier way to pay online.">**
**<img alt="" src="https://www.paypal.com/en_GB/i/scr/pixel.gif" width="1" height="1">**
**</form>**
</div>
...
![images](images/square.jpg) **注意**每个按钮的 PayPal 代码通常包含属性`border="0"` *。*这个边框最好用 CSS 标记去掉；因此，请从列表中删除边框属性，以便您的页面可以验证。

这个[清单 10-1b](#list_10_1b) 是[清单 10-1a](#list_10_1a) 的 CSS 样式表。它为图像和 PayPal 按钮创建框，而不使用废弃的表格。
...
body {font-family:"times new roman"; font-size:medium; color:black; ![images](images/U002.jpg)
background:white url('images/yellowgradient2.gif') repeat-x;
}
...
.box { margin:0 150px 0 190px; padding:5px; text-align:center; border:1px solid black; ![images](images/U002.jpg)
border-bottom:0;
}
...
h2 {font-size:x-large; font-weight bold; margin-top:5px; margin-bottom:5px; ![images](images/U002.jpg)
font-weight:bold;
}
...
![images](images/square.jpg) **提示**使用相同的过程，可以下载订阅按钮并设置各种选项，如金额和续订日期。

安全捐赠按钮如[图 10-3](#fig_10_3) 所示。

![images](images/9781430242758_Fig10-03.jpg)
...
<input type="image" src="https://www.paypal.com/en_US/GB/i/btn/btn_donateCC_LG.gif" ![images](images/U002.jpg)
...
![images](images/9781430242758_Fig10-04.jpg)
...
![images](images/square.jpg) **注**会员可以同时拥有一个个人账户和一个企业/卓越理财账户。出于测试目的，会员可能希望开立一个单独的个人 PayPal 账户。
