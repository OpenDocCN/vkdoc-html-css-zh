...
*有一个由 Thany 创建的方便的应用(`[http://j.mp/thany](http://j.mp/thany)<sup>[18](#CHP-11-FN-18)</sup>`)，可以让你在不同的浏览器中查看盒子阴影的渲染差异。您只需检查您希望看到的浏览器并查看示例。目前您可以查看 Firefox 3.6 和 4、Internet Explorer 9、Chrome 10、Safari 5、Opera 11.10、Android 2.2、iOS 4.2 和 Opera Mobile 11。*
