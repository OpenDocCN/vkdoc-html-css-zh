...
![Image](img/square.jpg) **注意**在过去的几年里，web 从静态网页转移到了 AJAX/Web 2.0 空间，变得更像应用程序。ARIA 的想法是开发一种可以插入到 HTML/XHTML 等宿主语言中的语言(它也可以与 SVG 一起使用)，这可以使使用 at 的残疾人更容易访问这些应用程序。
