...
滑块在 web 应用中非常受欢迎，尤其是在配置器中，如[图 4-11](#fig_4_11) 所示的 Kayak.com 网站页面。
...
在这一章中，你已经了解了使用 HTML5 表单，现在可以更快更有效地开发具有高级终端用户体验的应用。在第 5 章中，你将学习如何使用新的 HTML5 音频和视频标签在网页中嵌入视频。