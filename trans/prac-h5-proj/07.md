...
![images](images/9781430242758_Fig07-01.jpg)

***图 7-1。**JavaScript 应用的圆角*

所见即所得设计程序可能无法正确显示边角。在浏览器中查看页面以查看圆角。

![images](images/square.jpg) **注**`files niftyCube.js`和`niftyCorners.css`必须从 Nifty Corners 网站或这本书的网页上下载。将文件包含在包含您的网页的文件夹中。HTML 没有链接到文件`niftyCorners.css`，但是 JavaScript 文件引用了它。本章的文件可以从该书的网页上下载。所有文件都有内部样式，仅供教学使用。
...
<head>
<style type="text/css">
body { padding: 20px;background: #FFF;color: #3C0012; text-align: center; ![images](images/U002.jpg)
    font:85%/1.45 "Arial";
}
...
<div id="container">
<div id="content">
<h1>Nifty Corners</h1>` `<p>This method of producing rounded corners was devised by a clever Italian ![images](images/U002.jpg)
called Alessandro Fulciniti. This is the content panel. </p>
<h2>Rounded corners without images</h2>
<p>Until all browsers accept the CSS3 rounded corners tag then this javascript ![images](images/U002.jpg)
...
![images](images/square.jpg) **注意**每个被赋予圆角的元素必须是带有`id`的`<div>`，例如`<div id="leftcol">`。您将无法对带有语义标签的项目进行圆角处理。因为 HTML5 不在乎你用语义标签还是`<div>` s，这不是问题，用`<div>` s 就行了，好消息是你也可以很容易的给你现有的 HTML4 和 XHTML 网页加圆角。
...
![images](images/9781430242758_Fig07-02.jpg)

***图 7-2。**显示圆角元素边框的整页*

![images](images/square.jpg) **注意**`<h1>`框的高度必须等于页眉图像的高度，减去任何顶部和底部的填充。中间面板(`midcol`)必须略高于侧柱。不要在中间面板上添加圆角，因为这会导致中间面板在 Internet Explorer 8 中低于外部列。
...
<meta charset=utf-8>
<style type="text/css">
body { width:100%; margin:auto; margin-top:0; padding: 10px; background: #bbd999; ![images](images/U002.jpg)
...
#container { width:960px; margin: 0 auto 10px auto; padding:10px;text-align:left; ![images](images/U002.jpg)
background:#FFF; position:relative; clear:both;
}
#mainpanel { width:960px; margin:auto; margin-bottom:0; margin-top:-25px; ![images](images/U002.jpg)
background-color:#cee1ba; text-align:center;
}
#hdr { padding-top:10px; width:100%; text-align:center; margin:auto; ![images](images/U002.jpg)
background-image:url('images/banner.jpg'); background-repeat:no-repeat; ![images](images/U002.jpg)
...
#ftr { clear:both;width:950px; background: #C4E786;padding:5px; margin-top:10px; ![images](images/U002.jpg)
text-align:center;` `}
ul.nav { list-style-type:none; padding-left:0; margin-left:0;
}
ul.nav a { display:block; width:90px; background:#cee1ba;; margin:0 auto 2px auto; ![images](images/U002.jpg)
padding:4px;
}
a.navbtn:link { color: navy; background-color:#cee1ba; text-decoration:none; ![images](images/U002.jpg)
font-weight:normal;
}
a.navbtn:visited { color: navy; background-color:#cee1ba; text-decoration: none; ![images](images/U002.jpg)
font-weight:normal;
}
a.navbtn:active { color: navy; background-color:#cee1ba; text-decoration: none; ![images](images/U002.jpg)
font-weight:normal;
}
a.navbtn:hover { color: red; background-color:#ffd154; text-decoration: none; ![images](images/U002.jpg)
font-weight:normal;
}
</style>
**        <script type="text/javascript" src="niftycube.js"></script>**
...
<p>This panel can be used for adverts, additional information, or items like ![images](images/U002.jpg)
...
<p>This method uses CSS and Javascript.<br>If Javascript is turned off in the ![images](images/U002.jpg)
users computer, the page differs only in that the corners are not rounded.&nbsp;&nbsp;</p>
A clever Italian called Alessandro Fulciniti produced this simple ![images](images/U002.jpg)
Javascript/CSS solution.<br><br>Full details can be found on his website
<a href="http://www.html.it/articoli/niftycube/index.html">![images](images/U002.jpg)
        www.html.it/articoli/niftycube/index.html</a>
</div>
<img alt="Coly River" height="196" src="images/colrivblu.jpg" width="298"></div><br>
</div>
...
![images](images/square.jpg) **注**菜单链接显示为`href="#"`。当然，这些必须更改为链接到您的页面。

### 带有圆形边框和圆形面板的网页

圆形边框可以扩展到页面边框内的项目，以给页面设计带来一致的感觉。[图 7-3](#fig_7_3) 是一个带有圆形边框和圆形内部面板的页面截图。

![images](images/9781430242758_Fig07-03.jpg)
...
div#container { width:950px; margin: 0 auto 10px auto; padding:10px;text-align:left; ![images](images/U002.jpg)
background:#FFF; position:relative; clear:both;
}
div#mainpanel { width:950px; margin:auto; margin-bottom:0; margin-top:-10px; ![images](images/U002.jpg)
background-color:#cee1ba; text-align:center;
}
#hdr { padding-top:10px; width:100%; text-align:center; margin:auto; ![images](images/U002.jpg)
background-image:url('images/banner.jpg'); background-repeat:no-repeat; ![images](images/U002.jpg)
...
#ftr { clear:both; width:940px; background: #C4E786; padding:5px; margin-top:10px; ![images](images/U002.jpg)
text-align:center;
}
ul#nav { list-style-type:none; padding-left:0; margin-left:0;
}
...
<h2>Middle panel for content</h2>
<ul id="about">
    <li id="adv1"><h3>Budget web Hosting from &pound;1.99 per month</h3><br>![images](images/U002.jpg)
    <a href="budget.html"><img alt="£1.99 per month. Read More" title="£1.99 per month. ![images](images/U002.jpg)
    Read More"height="39" src="images/read-more.gif" width="117" ></a><br></li>
    <li id="adv2"><h3>Pro web Hosting from &pound;2.99 per month</h3><br>![images](images/U002.jpg)
    <a href="proweb.html"><img alt="£2.99 per month. Read More" title="£2.99 per month. ![images](images/U002.jpg)
    Read More"height="39" src="images/read-more.gif" width="117" ></a></li>
    <li id="adv3"><h3>Advanced web Hosting from &pound;4.99 per month</h3><br>
    <a href="advanced.html"><img alt="£4.99 per month. Read More" title="£4.99 per month. ![images](images/U002.jpg)
    Read More"height="39" src="images/read-more.gif" width="117" ></a></li>
</ul>
<br style="clear:both;">
</div>
...
![images](images/9781430242758_Fig07-04.jpg)
...
![images](images/9781430242758_Fig07-05.jpg)
...
Javascript solution must be used. <br>Microsoft has promised that IE 9 will enable ![images](images/U002.jpg)
rounded corners
</p>` `</body>
</html>`
...
![images](images/9781430242758_Fig07-06.jpg)
...
[图 7-7](#fig_7_7) 显示了文本块周围的黑色边框。

![images](images/9781430242758_Fig07-07.jpg)
...
meta content goes here
<style type="text/css">
#box-1 { margin:auto; text-align:left; border:2px #000 solid;width:300px; height:150px; ![images](images/U002.jpg)
...
<p>&nbsp;</p>
<p id="box-1"><strong>An example of four identical rounded corners</strong><br>
Each corner has a radius of 20 pixels<br>This works with Safari, Opera and Chrome. ![images](images/U002.jpg)
Mozilla needs the -moz- hack to make it work<br>For IE 7 and 8 the Javascript solution ![images](images/U002.jpg)
must be used. <br>IE 9 has promised it will work with rounded corners</p>
</body>
</html>`

![images](images/square.jpg) **注**下一个 CSS3 边框半径项目有`-moz` hacks。久而久之，Mozilla Firefox 将不需要`–moz`黑客。尝试注释掉黑客，偶尔用 Mozilla Firefox 测试代码。黑客将允许支持旧版本的 Firefox，现代版本应该会忽略这一点。
...
![images](images/9781430242758_Fig07-08.jpg)
...
        meta content goes here
<style type="text/css">
#box-1 { margin:auto; text-align:left; padding:15px; border:2px black solid; ![images](images/U002.jpg)
width:300px; height:150px; background-color:#F90; ![images](images/U002.jpg)
border-radius: 30px 20px 0 10px ; ![images](images/U002.jpg)
...
<body>
<p>&nbsp;</p>
<p id="box-1"><strong>An example of four different corners</strong><br>![images](images/U002.jpg)
Top left is 30 pixels radius, top right is 20 pixels, bottom right has no radius, ![images](images/U002.jpg)
bottom left has a 10 pixel radius.<br>This works with Safari, Opera and Chrome. Mozilla ![images](images/U002.jpg)
needs the -moz- hack to make it work<br>For IE 7 and 8 the Nifty Corners Javascript ![images](images/U002.jpg)
...
![images](images/9781430242758_Fig07-09.jpg)
...
`#box-1 { margin:auto; text-align:center; border:30px #FFCC66 solid; width:250px; ![images](images/U002.jpg)
...
![images](images/9781430242758_Fig07-10.jpg)
...
![images](images/9781430242758_Fig07-11.jpg)
...
![images](images/square.jpg) **注意**标签 3 比其他的都长。标签会自动放大或缩小以适应文本。
...
![images](images/square.jpg) **注意**每个`href="#"`当然必须被你的页面的 URL 所取代。必须在每个页面上更改活动链接的`id`以匹配页面。例如，在第 5 页上，活动链接的 id 将出现在第 5 页链接的旁边，即`<li><a class="tab" **id="activelink"** href="#">Tab5</a></li>`，在该页上，第一个选项卡将变成`<li><a class="tab" href="#">Tab1</a></li>`。[图 7-13](#fig_7_13) 显示了结果。

[清单 7-11b](#list_7_11b) 是图 7-11 中[所示圆形标签菜单的 CSS3 样式表。](#fig_7_11)

***清单 7-11b。**为[清单 7-11a](#list_7_11a) (css3-tabs.css)* 创建 CSS 标记

`#header { width:500px; height:100px; background-image:url('images/bluepan.jpg'); ![images](images/U002.jpg)
background-repeat:no-repeat; background-position:center; color:white; text-align:center;![images](images/U002.jpg)
margin-bottom:-27px;
}
...
ul li a.tab { font-family:Arial; color:black; font-size :medium; font-weight:bold; ![images](images/U002.jpg)
background-color:#ffff00; ![images](images/U002.jpg)
**/*-moz-border-radius-topleft:8px;É-moz-border-radius-topright:8px;*/**
border-top-left-radius:8px; border-top-right-radius:8px; border:2px solid black; ![images](images/U002.jpg)
...
![images](images/square.jpg) **注意**CSS 样式表中粗体显示的注释掉的行[清单 7-11b](#list_7_11b) 对于 Mozilla Firefox 以后的版本是不需要的。粗体文本中的项目现在可以省略，但是如果你也想迎合 Firefox 的早期版本，请删除注释符号。

[图 7-12](#fig_7_12) 显示了选择 tab5 时的菜单。

![images](images/9781430242758_Fig07-12.jpg)

***图 7-12。**第五页的标签已经被选中*

[图 7-13](#fig_7_13) 显示了标签菜单在 IE 7 和 IE 8 中是如何出现的。

![images](images/9781430242758_Fig07-13.jpg)
