...
让我们从视觉上来看看这些效果。在[图 9-2](#Fig2) 中的两个截图共享在[清单 9-1](#list1) 中显示的相同的基本代码。
...
CSS 的改变为图像提供了正确的变换，正如你在[图 9-4](#Fig4) 中看到的。
...
***[清单 9-15](#_list15) 。*T5 圆形 3D 图库的 CSS 底纹效果**
