...
当然，您可以发挥您的想象力，将这些原则应用到许多有趣且引人注目的图形应用程序中。

## 创造一个棋盘

在第一个应用程序中，您将绘制一个棋盘，它只是一系列颜色交替的方块。我将向你展示如何使用渐变来使棋盘更有趣一点。您将使用图像文件在适当的方格中绘制棋子。最后，您将应用一点动画来移动棋盘上的棋子。这将让你在进入更高级的话题之前，对基本的绘画技巧有一个很好的了解。
...
![A978-1-4842-1147-2_10_Fig1_HTML.gif](A978-1-4842-1147-2_10_Fig1_HTML.gif)
...
保存您的更改，然后按 F5 启动应用程序。该页面现在应该如图 [10-2](#Fig2) 所示。请注意，颜色会在整个画布上过渡，而不是在每个方块上过渡。

![A978-1-4842-1147-2_10_Fig2_HTML.gif](A978-1-4842-1147-2_10_Fig2_HTML.gif)
...
在这个应用程序中，您将使用 12 幅不同的图像绘制 32 幅作品。此外，在本章的后面，您将添加代码来移动这些部分。为了方便起见，您将在应用程序中添加一些结构。您将定义一个存储棋子属性的类，例如要使用的图像及其在棋盘上的位置。然后，您将实现一个使用这些属性的细节的通用绘图函数。
...
Add the `loadImages()` function, shown in Listing [10-3](#FPar3), to your `script` element after the existing `drawBoard()` function.  
...
![A978-1-4842-1147-2_10_Fig3_HTML.jpg](A978-1-4842-1147-2_10_Fig3_HTML.jpg)
...
![A978-1-4842-1147-2_10_Fig4_HTML.jpg](A978-1-4842-1147-2_10_Fig4_HTML.jpg)
...
![A978-1-4842-1147-2_10_Fig5_HTML.gif](A978-1-4842-1147-2_10_Fig5_HTML.gif)
...
![A978-1-4842-1147-2_10_Fig6_HTML.gif](A978-1-4842-1147-2_10_Fig6_HTML.gif)
...
![A978-1-4842-1147-2_10_Fig7_HTML.gif](A978-1-4842-1147-2_10_Fig7_HTML.gif)
...
![A978-1-4842-1147-2_10_Fig9_HTML.jpg](A978-1-4842-1147-2_10_Fig9_HTML.jpg)
...
![A978-1-4842-1147-2_10_Fig8_HTML.jpg](A978-1-4842-1147-2_10_Fig8_HTML.jpg)
...
![A978-1-4842-1147-2_10_Fig10_HTML.jpg](A978-1-4842-1147-2_10_Fig10_HTML.jpg)
...
![A978-1-4842-1147-2_10_Fig11_HTML.jpg](A978-1-4842-1147-2_10_Fig11_HTML.jpg)
...
按 F5 键启动应用程序，它看起来应该如图 [10-12](#Fig12) 所示。

![A978-1-4842-1147-2_10_Fig12_HTML.jpg](A978-1-4842-1147-2_10_Fig12_HTML.jpg)
...
这在棋盘上定义了一个圆圈，圆圈之外的任何东西都是不可见的。按 F5 键启动应用程序，它看起来应该如图 [10-13](#Fig13) 所示。

![A978-1-4842-1147-2_10_Fig13_HTML.jpg](A978-1-4842-1147-2_10_Fig13_HTML.jpg)
...
![A978-1-4842-1147-2_10_Fig14_HTML.jpg](A978-1-4842-1147-2_10_Fig14_HTML.jpg)
...
在本章中，您使用了 canvas 元素来创建一些图形化的 web 页面。您使用矩形和路径在画布上绘制形状。你还在画布上加入了图像。canvas 真正强大的特性之一是应用转换的能力。适当地使用转换确实可以简化一些复杂的绘图应用程序。
