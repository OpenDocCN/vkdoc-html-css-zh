...
现在你已经有了最终的图像素材，只需使用[清单 5-12](#list12) 中所示的 CSS 代码来调整这个 sprite 工作表的 CSS。
...
最后，创建 sprite 工作表的一个非常好的工具是直接的 Adobe Flash CS6，但是它的价格很高。因此，如果你没有 Flash，我建议你下载格兰特·斯金纳和他的团队开发的 AIR 应用 Zoe([http://easeljs.com/zoe.html](http://easeljs.com/zoe.html))，或者使用一些免费的在线工具，叫做 SpritePad(【http://spritepad.wearekiss.com】T3【个人最喜欢的】，和 SpriteCow([http://spritecow.com](http://spritecow.com))。前往[http://css-tricks.com/css-sprites](http://css-tricks.com/css-sprites)了解更多关于 sprite sheet 使用的详细信息。
...
在第 6 章中，焦点转移回 HTML5 领域，尤其是新的 JavaScript APIs 可以利用。我们将更详细地讨论一些更新的可用标记和元素，包括 HTML5 输入，以及拖放 API 和 Web 工作器。