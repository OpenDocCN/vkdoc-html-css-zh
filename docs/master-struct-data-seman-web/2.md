...
![A978-1-4842-1049-9_2_Fig2a_HTML.jpg](A978-1-4842-1049-9_2_Fig2a_HTML.jpg)。
...
RDF 数据模型基于描述和表征资源(尤其是 web 资源)的语句，以称为 RDF 三元组或 RDF 语句的主-谓-对象(资源-属性-值)表达式的形式。谓语(性质)描述主语和宾语之间的关系。比如自然语言句子“Leslie 的主页是 [`http://www.lesliesikos.com`](http://www.lesliesikos.com/) ”可以表达为表 [2-4](#Tab4) 所示。三元组的所有元素都是由唯一的 URI 定义的资源(参见清单 [2-4](#FPar5) )。
...
![A978-1-4842-1049-9_2_Fig1_HTML.gif](A978-1-4842-1049-9_2_Fig1_HTML.gif)
...
![A978-1-4842-1049-9_2_Fig4_HTML.jpg](A978-1-4842-1049-9_2_Fig4_HTML.jpg)

图 2-4。

A graph generated from an RDF file

![A978-1-4842-1049-9_2_Fig3_HTML.jpg](A978-1-4842-1049-9_2_Fig3_HTML.jpg)

图 2-3。

A personal description extracted from RDF and displayed on a web page

![A978-1-4842-1049-9_2_Fig2_HTML.jpg](A978-1-4842-1049-9_2_Fig2_HTML.jpg)
...
`<div>Dates: <abbr class="dtstart" title="20151012T093000Z">October 12 2015, 9.30am` ![A978-1-4842-1049-9_2_Fig2ab_HTML.jpg](A978-1-4842-1049-9_2_Fig2ab_HTML.jpg)

`UTC</abbr> – <abbr class="dtend" title="20151014T200000Z">October 14 2015, 8.00pm` ![A978-1-4842-1049-9_2_Fig2ac_HTML.jpg](A978-1-4842-1049-9_2_Fig2ac_HTML.jpg)
...
`by <span class="fn">John Smith</span>, <span class="title">Editor</span>` ![A978-1-4842-1049-9_2_Fig2ad_HTML.jpg](A978-1-4842-1049-9_2_Fig2ad_HTML.jpg)
...
`My name is <span property="name">Leslie Sikos</span> and you can find out more about me` ![A978-1-4842-1049-9_2_Fig2ai_HTML.jpg](A978-1-4842-1049-9_2_Fig2ai_HTML.jpg)
...
`My name is <span property="name">Leslie Sikos</span> and you can find out more about me` ![A978-1-4842-1049-9_2_Fig2ak_HTML.jpg](A978-1-4842-1049-9_2_Fig2ak_HTML.jpg)

`by visiting <a property="url" href="`[`http://www.lesliesikos.com`](http://www.lesliesikos.com)T2】

`I am the author of <a``property="fabio:Textbook"`T2】

`href="`[`http://lesliesikos.com/mastering-structured-data-on-the-semantic-web/`](http://lesliesikos.com/mastering-structured-data-on-the-semantic-web/)>掌握![A978-1-4842-1049-9_2_Fig2am_HTML.jpg](A978-1-4842-1049-9_2_Fig2am_HTML.jpg)
...
当前主题是文档的网址 [<sup>5</sup>](#Fn5) 或宿主语言设置的值，如(X)HTML 中的`base`元素。因此，在默认情况下，文档中写入的任何元数据都将涉及文档本身。`about`属性可以用来改变当前的主题并声明数据是关于什么的，使文档体中的属性成为新对象的一部分，而不是引用整个文档(就像它们在文档头中那样)。
...
`rel="cc:license"` ![A978-1-4842-1049-9_2_Fig2ap_HTML.jpg](A978-1-4842-1049-9_2_Fig2ap_HTML.jpg)
...
`<link about="mailto:leslie@example.com"` ![A978-1-4842-1049-9_2_Fig2ar_HTML.jpg](A978-1-4842-1049-9_2_Fig2ar_HTML.jpg)

`rel="foaf:knows" href="mailto:christina@example.com" />`

两个资源(谓词)之间的反向关系可以用`rev`属性来表达。`rel`和`rev`属性可以单独或一起用在任何元素上。当有两种不同的关系要表达时，组合`rel`和`rev`特别有用，比如一张照片是由照片中描绘的人拍摄的(参见清单 [2-29](#FPar34) )。
...
`<p prefix="bibo:`[`http://purl.org/ontology/bibo/`](http://purl.org/ontology/bibo/)`dc:`[`http://purl.org/dc/terms/`](http://purl.org/dc/terms/)`"`![A978-1-4842-1049-9_2_Fig2as_HTML.jpg](A978-1-4842-1049-9_2_Fig2as_HTML.jpg)

`typeof="bibo:Website">`

`The web site <span property="dc:title">Andrew Peno Graphic and Fine Artist</span> by` ![A978-1-4842-1049-9_2_Fig2at_HTML.jpg](A978-1-4842-1049-9_2_Fig2at_HTML.jpg)
...
`<span itemprop="name">Web Standards: Mastering HTML5, CSS3, and XML</span>` ![A978-1-4842-1049-9_2_Fig2ax_HTML.jpg](A978-1-4842-1049-9_2_Fig2ax_HTML.jpg)
...
`"`[`http://schema.org/Person`](http://schema.org/Person)T2】
...
`"@id": "`[`http://www.lesliesikos.com/images/lesliesikos.jpg`](http://www.lesliesikos.com/images/lesliesikos.jpg)T2】
...
`The RDF data is extracted by <a rel="profileTransformation"` ![A978-1-4842-1049-9_2_Fig2ay_HTML.jpg](A978-1-4842-1049-9_2_Fig2ay_HTML.jpg)
...
![A978-1-4842-1049-9_2_Fig5_HTML.jpg](A978-1-4842-1049-9_2_Fig5_HTML.jpg)
...
![A978-1-4842-1049-9_2_Fig6_HTML.jpg](A978-1-4842-1049-9_2_Fig6_HTML.jpg)
...
![A978-1-4842-1049-9_2_Fig7_HTML.gif](A978-1-4842-1049-9_2_Fig7_HTML.gif)
...
`rdfs:comment "Web Standards: Mastering HTML5, CSS3, and XML presents step-by-step` ![A978-1-4842-1049-9_2_Fig2az_HTML.jpg](A978-1-4842-1049-9_2_Fig2az_HTML.jpg)

`guides based on solid design principles and best practices, and shows the most common` ![A978-1-4842-1049-9_2_Fig2ba_HTML.jpg](A978-1-4842-1049-9_2_Fig2ba_HTML.jpg)

`web development tools and web design frameworks. You will master HTML5 and its XML` ![A978-1-4842-1049-9_2_Fig2bb_HTML.jpg](A978-1-4842-1049-9_2_Fig2bb_HTML.jpg)

`serialization, XHTML5, the new structuring and multimedia elements, the most important`

![A978-1-4842-1049-9_2_Fig2bc_HTML.jpg](A978-1-4842-1049-9_2_Fig2bc_HTML.jpg)

`HTML5 APIs, and understand the standardization process of HTML 5.1, HTML 5.2, and` ![A978-1-4842-1049-9_2_Fig2bd_HTML.jpg](A978-1-4842-1049-9_2_Fig2bd_HTML.jpg)
...
在高层，可以使用 OWL 抽象语法[ [29](#Sec52) 和 OWL2 函数语法[ [30](#Sec52) ]。OWL 还支持几种交换语法，包括 RDF 语法，如 RDF/XML 和 RDF/Turtle、OWL2 XML 语法[ [31](#Sec52) ]和 Manchester 语法[ [32](#Sec52) ]，但 RDF/XML 是标准语法。

Note

在示例中，我对一个假想的智能手机本体使用声明。

OWL2 函数语法与统一建模语言(UML)兼容，UML 是部署最广泛的通用标准化建模语言之一(参见清单 [2-51](#FPar62) )。它是干净的、可调整的、可修改的，并且易于解析。函数语法主要用于在 W3C 规范中定义正式的 OWL2 语法。

Listing 2-51\. OWL2 Functional Syntax Example

`Prefix(owl:=<``http://www.w3.org/2002/07/owl#`T2】
...
OWL2 函数语法的符号变体是 OWL/XML 语法，它使用 XML 树结构而不是 RDF 三元组，如清单 [2-52](#FPar63) 所示。

Listing 2-52\. OWL2 XML Syntax Example

`<Ontology ontologyIRI="http://example.com/smartphone.owl">`

`<Prefix name="owl" IRI="``http://www.w3.org/2002/07/owl#`T2】
...
OWL 2 的唯一标准语法是 RDF/XML 语法(参见清单 [2-53](#FPar64) )。每个符合 OWL2 的工具都支持这种语法。

Listing 2-53\. RDF/XML Syntax Example

`<rdf:RDF` ![A978-1-4842-1049-9_2_Fig2be_HTML.jpg](A978-1-4842-1049-9_2_Fig2be_HTML.jpg)
...
清单 [2-54](#FPar65) 中显示的 RDF/Turtle 语法是表示 OWL 本体的 RDF 三元组的简单语法。
...
不常用的曼彻斯特语法是 OWL-DL 的一种简洁、用户友好的语法，它将关于特定类、属性或个人的信息收集到一个称为帧的结构中。曼彻斯特语法易于阅读和书写，特别是对于那些不是数学逻辑专家的人来说。复杂的描述由简短、有意义的英文单词组成，同时消除了其他语法中表示的逻辑符号和优先规则，如清单 [2-55](#FPar66) 所示。

Listing 2-55\. Manchester Syntax Example

`Prefix: owl: <`[`http://www.w3.org/2002/07/owl`](http://www.w3.org/2002/07/owl)T2】
...
属性特征由属性公理定义。基本形式只表达存在。例如，在智能手机本体中，可以声明属性`hasTouchscreen`来表达手机的一个主要特性(参见清单 [2-56](#FPar67) )。

Listing 2-56\. A Property Declaration in OWL

`<owl:ObjectProperty rdf:ID="hasTouchscreen" />`

OWL 属性公理也可以定义额外的特征。OWL 重用 RDF 模式结构，如`rdfs:subPropertyOf`、`rdfs:domain`和`rdfs:range`。与其他属性的关系可以用`owl:equivalentProperty`和`owl:inverseOf`来表示(列表 [2-57](#FPar68) )。
...
全局基数约束由`owl:FunctionalProperty`和`owl:InverseFunctionalProperty`定义(参见清单 [2-58](#FPar69) )。对称性和传递性特征由`owl:SymmetricProperty`和`owl:TransitiveProperty` [ [33](#Sec52) 定义。
...
OWL 为表达关系提供了精确的声明，即使它们是显而易见的。例如，两个智能手机特性的属性层次可以用`rdfs:subPropertyOf`来表示，如清单 [2-59](#FPar70) 所示。
...
Class identifier (URI reference). A named instance of `owl:Class`, a subclass of `rdfs:Class`.[<sup>10</sup>](#Fn10) Listing [2-60](#FPar71) shows an example.   Listing 2-60\. A Class Identifier in OWL

`<owl:Class rdf:ID="Handheld"/>`

Set of individuals (instances of a class) defined by the `owl:oneOf` property. For example, the class of smartphones can be declared in the RDF/XML syntax, with the RDF construct `rdf:parseType="Collection"`, as shown in Listing [2-61](#FPar72).   Listing 2-61\. Declaring Class Instances in OWL
...
Property restriction: a value constraint or a cardinality constraint (for example, see Listing [2-62](#FPar73)).   Listing 2-62\. Property Restrictions in OWL
...
Intersection of two or more class descriptions. For example, the intersection of the `Smartphone` and the `MadeByApple` classes can be described by `owl:intersectionOf`, stating that iPhones are smartphones made by Apple (see Listing [2-63](#FPar74)).   Listing 2-63\. Intersection in OWL
...
类描述可以组合成类公理。类的层次结构可以用一个子类公理来表示(列表 [2-64](#FPar75) )。
...
两个类的等价性表示它们所包含的个体是相同的。清单 [2-65](#FPar76) 显示了一个例子。
...
虽然一般来说，个人可以是几个类别的成员，但在许多情况下，成员资格是排他性的。例如，智能手机要么有物理键盘，要么有虚拟键盘(在触摸屏上)。这种类的不连续性可以用清单 [2-66](#FPar77) 来表示。
...
简单知识组织系统(SKOS)是 W3C 推荐的表示分类法、叙词表、分类方案、主题-标题系统和结构化受控词汇表的标准。作为工业应用程序中最常实现的语义 Web 标准之一，SKOS 建立在 RDF 和 RDFS 的基础上，支持将受控词汇表作为链接数据轻松发布。RDF 提供了互操作性、一致性和完整性，并允许知识组织系统用于分布式的、分散的元数据应用程序，其中元数据是从多个资源中检索的。

SKOS 标准将 SKOS 数据模型定义为完整的 OWL 本体[ [34](#Sec52) ]。SKOS 数据模型的元素是 OWL 类和带有单个 URIs 的属性，它们构成了 SKOS 词汇表。sko 的类和属性适合于表示叙词表的共同特征(在同义词和相关概念组中列出单词)。sko 的抽象概念由术语表示，可以使用关系(如`broader`和`narrower`)组织成层次结构，或者通过非层次(关联)关系(如`related`)链接起来。进一步的 SKOS 类和谓词可用于基本描述(`Concept`、`ConceptScheme`)、标记(`prefLabel`、`altLabel`、`prefSymbol`、`altSymbol`)、文档(`definition`、`scopeNote`、`changeNote`)、主题索引(`subject`、`isSubjectOf`)、分组(`Collection`、`OrderedCollection`)和主题指示(`subjectIndicator`)。SKOS 还提供了一些类似于 RDFS 推理规则的推理规则。
...
规则交换格式(RIF)是为现有规则系统之间的规则共享和交换而设计的，换句话说，允许为一个应用程序编写的规则在其他应用程序和规则引擎中共享和重用，同时保留语义。RIF 是一组严格定义的规则语言，称为方言。RIF 的核心方言是大多数规则引擎的公共子集。基本逻辑方言(BLD)增加了逻辑函数、等式和命名参数，并支持 Horn 逻辑(文字的析取，最多有一个正文字)。产生式规则方言(PRD)在规则结论中提供具有副作用的动作。RIF 有一个到 RDF 的映射。
