...
![images](img/square.jpg) **注意**你可以在`[http://w3schools.com/html5/default.asp](http://w3schools.com/html5/default.asp)`找到一个整洁方便的 HTML5 标签引用。
...
![images](img/square.jpg) **注意**web 应用程序也使用 CSS 文件来处理 web 表单的外观。您可以从[第 1 章](01.html)代码下载中获得该项目的完整源代码，包括 CSS 文件。
...
![images](img/square.jpg) **注意**尽管您在本节中构建的 web 应用程序不依赖于特定版本的 MVC，但是这里显示的屏幕截图假设您已经选择了 MVC4 项目模板。
