...
![images](img/square.jpg) **注意**你可以在[http://clikz.us/BookExamples/linkControl.php](http://clikz.us/BookExamples/linkControl.php)看到[图 11-1](#fig_11_1) 中的链接在浏览器中的样子
...
[清单 11-7](#list_11_7) 为所有类型的链接(除了简单链接)设置了一些公共属性(`position`和`padding-right`)。
