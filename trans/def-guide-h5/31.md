...
![Image](images/square.jpg) **提示**一些浏览器通过`window`对象支持这些事件，我在[第 27 章](27.html#ch27)中描述过。

#### 链接元素

`link`元素由`HTMLLinkElement`对象表示，该对象定义了[表 31-3](#tab_31_3) 中所示的属性。

![Image](images/t3103.jpg)
...
![Image](images/t3108.jpg)

![Image](images/t3108a.jpg)
