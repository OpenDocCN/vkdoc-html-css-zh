...
 data="__FLASH__.SWF">
                <!-- Firefox uses the `data` attribute above, IE/Safari uses the param![images](images/U002.jpg)
below -->
...
                <!-- fallback image. note the title field below, put the title of the![images](images/U002.jpg)
video there -->
