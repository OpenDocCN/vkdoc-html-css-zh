...
1.  Create the following HTML5 page: `<!DOCTYPE HTML>
    ...
            <title>Understanding the Occasionally Connected Applications - Testing Network![images](images/U002.jpg)
     Status</title>
...
                for (var i in window) {
                        switch (i) {
                                case "sessionStorage":![images](images/U002.jpg)
        document.getElementById("session").innerHTML = "supported";
                                break;
                                case "localStorage":![images](images/U002.jpg)
...
3.  create an empty file called myCache.manifest and just type CACHE MANIFEST to create a simple manifest And add a reference to it in our file `<html manifest="myCache.manifest">`
    ...
    *   现在将 manifest 文件重命名回他原来的名字:刷新页面应该会显示截图([图 11-4](#fig_11_4) )。![images](images/1104.jpg)
...
*   On Windows:
    ...
    工具![images](images/rtrif.jpg)选项![images](images/rtrif.jpg)高级![images](images/rtrif.jpg)网络![images](images/rtrif.jpg)离线存储

*   On OSX:

    火狐![images](images/rtrif.jpg)偏好![images](images/rtrif.jpg)高级![images](images/rtrif.jpg)网络![images](images/rtrif.jpg)离线存储
...
了解 Chrome 中不同种类的缓存的最佳方式是使用内置的开发工具。要启用它们，单击菜单中的工具![images](images/rtrif.jpg)开发人员工具。然后在工具栏中选择 Resources，您将可以访问各种存储和缓存的详细视图，从 Cookies 到应用程序缓存。
...
*   On Windows:
    ...
    菜单![images](images/rtrif.jpg)设置![images](images/rtrif.jpg)首选项![images](images/rtrif.jpg)高级![images](images/rtrif.jpg)存储
...
和谷歌浏览器一样，你必须启用开发者工具。为此，在设置菜单中，选择首选项![images](images/rtrif.jpg)高级，然后单击菜单栏中的显示开发。然后，在菜单中，点击开发![images](images/rtrif.jpg)显示网页检查器，并点击存储。
