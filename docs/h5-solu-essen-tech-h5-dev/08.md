...
`          <p>
          <input type="text" id="message" value="This message is contained within the main![images](images/U002.jpg)
window" style="width: 350px" /> <button id="sendBtn"> Send Message </button>
          </p>
     <br />
   <p>
<iframe id="chatFrame" src="http://www.comtaste.com/demo/chatIframe.html" style=![images](images/U002.jpg)
...
function sendMsg()
{
        document.getElementById('chatFrame').contentWindow.postMessage(document.![images](images/U002.jpg)
...
          </p>
     <br />
   <p>       <iframe id="chatFrame" src="http://www.comtaste.com/demo/chatIframe.html"![images](images/U002.jpg)
...
[图 8-1](#fig_8_1) 显示了两个网页之间交换消息的最终结果。
...
                            msgHandler ('<a target="_blank" href="mailto:' + msgSplit [1] +![images](images/U002.jpg)
 '/">' + msgSplit [0] + '</a>');
                            return ;
                        }
...
{
output.value += " Your browser supports the XMLHttpRequest Level 2 and its cross-origin![images](images/U002.jpg)
 feature !";
