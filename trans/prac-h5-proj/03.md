...
![images](img/square.jpg) **注**本章后面会描述几种背景，但是关于 CSS3 背景渐变的信息请参见[第 5 章](05.html#ch5)。
...
***清单 3-5b。**[清单 3-5a 的 CSS 样式表](#list_3_5a) (grad-pic-text.css)*
...
[清单 3-6b](#list_3_6b) 包括重新定位玫瑰花结的说明，以粗体显示。
...
CSS [清单 3-7b](#list_3_7b) 包含了创建透明内容框的代码，这些代码以粗体显示。
...
一个简单无序的菜单列表看起来像[图 3-8](#fig_3_8) 。图形背景项目符号可以增强菜单列表，如图[图 3-9](#fig_3_9) 所示。使用`text-decoration:none;`删除链接下方的下划线。使用 CSS 代码`background-image:url(img/*image*.gif)`可以用背景图片替换标准项目符号。
...
在 CSS [清单 3-12b](#list_3_12b) 中，三个方块用粗体表示。
