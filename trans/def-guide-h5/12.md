...
一般来说，自动完成表单对用户是有益的，对 web 应用没有什么影响。但是有些时候你不希望浏览器填写表单。[清单 12-5](#list_12_5) 展示了如何在`form`元素上使用`autocomplete`属性来实现这一点。
...
你可以在[图 12-11](#fig_12_11) 中看到重置表单的效果。
