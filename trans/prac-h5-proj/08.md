...
![images](images/square.jpg) **提示**关于 CSS3 盒子阴影的更多信息见`[http://www.css3.info/preview/box-shadow/](http://www.css3.info/preview/box-shadow/)`
...
![images](images/square.jpg) **注意**一定要把图像的尺寸放在样式表中。例如，一个 296 像素宽、196 像素高的图像需要一个 CSS 语句，如下所示:

`#shadow { box-shadow: 6px 6px 6px #888; **width: 296px; height:196px;** }`

彩色段落的 CSS3 阴影显示在[图 8-1](#fig_8_1) 中。

![images](images/9781430242758_Fig08-01.jpg)
...
`#para-shadow p { box-shadow: 6px 6px 8px #888; padding: 5px 5px 5px 15px; width:300px; ![images](images/U002.jpg)
background-color:#66FF99; color:black; font-weight:bold;
}`

[图 8-2](#fig_8_2) 显示了一张图片的 CSS3 阴影。本章中使用的科利河照片是由科林·海恩斯许可的。

![images](images/9781430242758_Fig08-02.jpg)
...
***清单 8-2b。**清单 8-2a[的 CSS 样式表(css3-image1.css)](#list_8_2a)*
...
![images](images/9781430242758_Fig08-03.jpg)
...
#shadow-bdr { **background-color:#fff; padding:10px;** box-shadow: 6px 6px 6px #78b; ![images](images/U002.jpg)
              width: 296px;
}`
...
![images](images/9781430242758_Fig08-04.jpg)
...
<body>
<div id="shadow">
<img alt="Coly River" title="Coly River" width="298" height="196" src="images/colrivblu.jpg">
</div>
<br><br>
</body>
</html>`
...
#banner h1 { color: #fff; padding: 50px 0 0 20px; margin: 0; font-size: 2.6em; ![images](images/U002.jpg)
...
1.  将图像加载到程序中。
2.  在四周添加 30 像素宽的边框。
3.  选择图层![images](images/U001.jpg)新建光栅图层。
4.  回到第一层。
5.  用魔棒点击新边框，用白色填充。
6.  单击选择并反转选择。
7.  选择效果![images](images/U001.jpg) 3D 效果![images](images/U001.jpg)投影。
8.  在下一个对话框中设置尺寸和不透明度。
9.  将图像移动到阴影上，直到您对外观满意为止。
10.  选择选择![images](images/U001.jpg)选择无。
11.  选择图层![images](images/U001.jpg)合并图层(展平)。
12.  裁剪顶部和左侧的白色边框。
13.  保存图像。

唷！结果是一个很好的投影，可以在 IE 7、IE 8 和所有更新的浏览器中看到，如图 8-7 所示。

![images](images/9781430242758_Fig08-07.jpg)
...
1.  将图像加载到 GIMP 中。
2.  选择滤镜![images](images/U001.jpg)光影。
3.  单击投影。

就这样！没有摆弄层，没有选择。[图 8-8](#fig_8_8) 显示了用 GIMP 2.6 和更早版本添加投影的结果。

![images](images/9781430242758_Fig08-08.jpg)
...
![images](images/9781430242758_Fig08-09.jpg)

***图 8-9。** GIMP 可以在文本上创建阴影。*

尝试以下练习:

1.  打开 GIMP，点击文件![images](images/U001.jpg)新建。
...
![images](images/9781430242758_Fig08-10.jpg)
...
.bottom-left-corner { background:url(bottom-leftcorner.png) left bottom no-repeat; ![images](images/U002.jpg)
...
![images](images/9781430242758_Fig08-11.jpg)
...
<img title="Coly River" alt="Coly River" width="318" height="216" ![images](images/U002.jpg)
**src="images/colrivblu-whitebdr.jpg">**
</div>
</div>
</div>
...
.top-right-corner { background:url('images/top-rightcorner.png') no-repeat right top; ![images](images/U002.jpg)
                    width: 326px;
}
.bottom-left-corner { background:url('images/bottom-leftcorner.png') no-repeat left bottom; ![images](images/U002.jpg)
                        padding-top:8px; padding-left:8px;
}
.shadowbox { background:url('images/main-shadow.png') right bottom;
}
...
<div class="shadowbox">
<div class="innerbox">
<img **class="frame"** title="Coly River" alt="Coly River" width="298" height="196" ![images](images/U002.jpg)
src="images/colrivblu.jpg">
</div>
</div>
</div>
</div>
...
HTML 中使用了类`.frame`来定位图像，以便添加白色边框。这个新行`img.frame { border:10px white solid; }`被添加到 CSS [清单 8-11d](#list_8_11d) (以粗体显示)。
...
![images](images/9781430242758_Fig08-12.jpg)
...
<div class="shadowbox">
<div class="innerbox">
<p>A paragraph can have a drop shadow. The shadow grows and shrinks ![images](images/U002.jpg)
...
[图 8-12](#fig_8_12) 在文本和段落内容框之间有 5 个像素的填充。这在下一个清单中以粗体显示。200 像素宽的内容加上左右填充给出了 220 像素的总宽度，这被添加到了`top-right-corner`的样式中(在[清单 8-12b](#list_8_12b) 中以粗体显示)。文本块被赋予一条细的银色边框，这样顶部和左侧的边缘清晰可见。
...
![images](images/9781430242758_Fig08-13.jpg)

***图 8-13。**窄窄的四面垂影*

![images](images/9781430242758_Fig08-14.jpg)

***图 8-14。**四面广坠影*

[图 8-13](#fig_8_13) 、 [8-14](#fig_8_14) 和 [8-15](#fig_8_15) 仅使用一个矩形阴影图像。

![images](images/square.jpg) **提示**可以从书的网页上下载有限数量的投影图像，或者你可以使用图形处理软件包创建自己的图像。投影图像必须是透明的`.png`文件。
...
![images](images/square.jpg) **注意**在清单中，`corner a`是右上角，`corner b`是左下角。
...
<img title=”River Coly” alt="River Coly" height="197" src="images/colriv.jpg"![images](images/U002.jpg)
...
[清单 8-13b](#list_8_13b) 使用单一矩形阴影图像、`shadow10p.png`和 CSS 定位。

***清单 8-13b。**清单 8-13a 的 CSS 样式表( fourside-drop10px.css)*

`.shadow-one { position:absolute; padding-top:20px; padding-left:20px;
}` `.corner-a { position:absolute; right:0; top:0; width:20px; height:20px; ![images](images/U002.jpg)
            background:url('images/shadow10p.png') right top no-repeat;
}
.corner-b { position:absolute; left:0; bottom:0; width:20px; height:20px; ![images](images/U002.jpg)
            background:url('images/shadow10p.png') left bottom no-repeat;
}
.shadow-two { position:relative; background :url('images/shadow10p.png') ![images](images/U002.jpg)
              right bottom no-repeat;
}
.shadow-three { position:relative; left:-20px; top:-20px; ![images](images/U002.jpg)
                background:url('images/shadow10p.png') left top no-repeat;
}
.shadow-four { position:relative; left:10px; top:10px;
}`

![images](images/square.jpg) **注意**在[图 8-13](#fig_8_13) 中，`.png`图像上阴影区域的宽度为 10 像素。CSS 清单中的 20 像素尺寸是`.png`阴影宽度的两倍。阴影四与`.png`阴影区域的宽度相同(10 像素)。
...
CSS [清单 8-14b](#list_8_14b) 使用单一矩形阴影图像、`shadow30p.png`和 CSS 定位。

***清单 8-14b。**清单 8-14a[的 CSS 样式表](#list_8_14a)*

`.shadow-one { position:absolute; padding-top:60px; padding-left:60px;
}
.corner-a { position:absolute; right:0; top:0; width:60px; height:60px; ![images](images/U002.jpg)
            background:url('images/shadow30px.png') right top no-repeat;
}
.corner-b { position:absolute; left:0; bottom:0; width:60px; height:60px; ![images](images/U002.jpg)
            background:url('images/shadow30px.png') left bottom no-repeat;
}
.shadow-two { position:relative; background :url('images/shadow30px.png') ![images](images/U002.jpg)
              right bottom no-repeat;
}
.shadow-three { position:relative; left:-60px; top:-60px; ![images](images/U002.jpg)
                background:url('images/shadow30px.png') left top no-repeat;
}
.shadow-four { position:relative; left:30px; top:30px;
}`

![images](images/square.jpg) **注意**在[图 8-14](#fig_8_14) 中，`.png`图像上阴影区域的宽度为 30 像素。60 像素的尺寸是`.png`阴影宽度的两倍。阴影四与`.png`阴影区域的宽度相同(30 像素)。

#### 段落周围的四边阴影

通过使用投影，可以使段落看起来好像漂浮在页面表面上。[图 8-15](#fig_8_15) 显示了一个没有边框但被阴影包围的段落。

![images](images/9781430242758_Fig08-15.jpg)
...
**        <div class="shadow-three">**
**        <div class="shadow-four">**
<p><b>Rare bureaucrat discovered</b><br>Bureaucrats and other public &#39;servants&#39; ![images](images/U002.jpg)
...
.corner-a { position:absolute; right:0; top:16px; width:60px; height:60px; ![images](images/U002.jpg)
background:url('images/shadow30px.png') right top no-repeat;
}
.corner-b { position:absolute; left:0; bottom:16px; width:60px; height:60px; ![images](images/U002.jpg)
background:url('images/shadow30px.png') left bottom no-repeat;
}
.shadow-two { position:relative; ![images](images/U002.jpg)
background :url('images/shadow30px.png') right bottom no-repeat;}
.shadow-three { position:relative; left:-60px; top:-60px; ![images](images/U002.jpg)
background:url( 'images/shadow30px.png' ) left top no-repeat; }
.shadow-four {position:relative; left:30px; top:30px; }
#wrapper { width:420px;
...
![images](images/9781430242758_Fig08-16.jpg)
...
4.  Select Fill With ![images](images/U001.jpg) Transparency, then click OK. The empty image is created; it is covered with a checkerboard pattern that denotes transparency. [Figure 8-17](#fig_8_17) shows the GIMP’s Toolbox window. ![images](images/9781430242758_Fig08-17.jpg)
...
6.  点击图层![images](images/U001.jpg)新建图层。确保选中透明度单选按钮，接受所有默认设置，然后单击确定。
7.  在菜单中，单击窗口![images](images/U001.jpg)可停靠对话框![images](images/U001.jpg)图层对话框。这将在屏幕上出现一个对话框，显示层。
8.  确保棋盘格图案的图层总是被选中(当它被选中时会有一个浅色背景；未选择的层将是白色的)。

现在我们将决定阴影图像的宽度，假设它是 20 像素。

1.  点击选择![images](images/U001.jpg)全部。现在你会看到虚线轮廓像一排行进的蚂蚁一样移动。
2.  点击选择![images](images/U001.jpg)缩小。一个对话框将允许您选择图像的缩小量；假设是 30 像素。
3.  确保勾选了标记为“从图像边框收缩”的框。单击确定。
4.  现在你会看到内部和外部图像有虚线边框。只有内在的形象才会有行进的蚂蚁。点击滤镜![images](images/U001.jpg)光影![images](images/U001.jpg)投影。
5.  在对话框中，将偏移设置为零，模糊半径为 20 像素，不透明度为 70。
6.  Make sure the box labeled Allow Resizing is unchecked. Click OK. You will see a third layer, called Drop Shadow, has appeared; just ignore it. The docked Layers window is illustrated in [Figure 8-18](#fig_8_18). ![images](images/9781430242758_Fig08-18.jpg)

    ***图 8-18。**GIMP 图层对话框*

7.  **不要保存它，**但是在图层对话框中点击与背景图层相关的眼球。现在你可以在编辑面板中看到投影，棋盘再次显露出来。
8.  点击文件![images](images/U001.jpg)另存为，选择保存位置。*在对话框的顶部*，给文件命名，并确保通过在文件名中添加`.png`来包含文件类型(例如:`mydropshadow.png`)。
...
![images](images/9781430242758_Fig08-19.jpg)
...
![images](images/9781430242758_Fig08-20.jpg)

***图 8-20。**阴影环绕整个页面的白色边框。这适用于所有浏览器。*

![images](images/square.jpg) **注意**通过使用新的 CSS3 模块，在标题面板的白色字体上添加了阴影。[清单 8-20](#list_8_20a) 、 [8-22](#list_8_22a) 和 [8-23](#list_8_23a) 中的 CSS3 文本阴影在 Internet Explorer 6、7、8 和 9 中不工作。IE 6 中的`.png`阴影是不透明的。
...
}` `header { width: 940px; height: 154px; margin: 0; border-bottom:10px white solid; ![images](images/U002.jpg)
background: url(images/bluepan.jpg);
}
...
header h1 { color: #fff; padding: 50px 0 0 20px; margin: 0; font-size: 2.6em; ![images](images/U002.jpg)
                text-shadow: 0.1em 0.1em 0.2em black;
}
...
#mainContent p, #mainContent h2, #mainContent h3, #mainContent h4, #mainContent ul, ![images](images/U002.jpg)
...
.corner-a {position:absolute; right:0; top:-20px; width:60px; height:60px; ![images](images/U002.jpg)
background:url('images/shadow30px.png') right top no-repeat;
}
.corner-b {position:absolute; left:0; bottom:0; width:60px; height:60px; ![images](images/U002.jpg)
background:url('images/shadow30px.png') left bottom no-repeat;
...
![images](images/square.jpg) **谨慎**这种方法虽然有效，但是有一个很大的弊端。此页面的垂直长度受到您选择的阴影图像尺寸的限制。[图 8-7](#fig_8_7) 中使用的 1024 像素阴影将页面的垂直高度限制为 980 像素，内容面板的垂直高度限制为 780 像素。在主页上不会有问题，主页不应该超过浏览器窗口的高度；但这可能会严重妨碍后续页面。
...
![images](images/9781430242758_Fig08-21.jpg)
...
![images](images/9781430242758_Fig08-22.jpg)
...
<h3>Man bites dog</h3>
<p>Cedric Sidebottam age 46, mistook his Yorkshire terrier for a hamburger; he ![images](images/U002.jpg)
spread mustard on the dog and then bit it.&nbsp; The dog recovered but Cedric ![images](images/U002.jpg)
...
`/*This css template is derived from a template created by Andy Budd (www.andybudd.com) ![images](images/U002.jpg)
for the book "Blog Design Solutions", and is released under a Creative Commons ![images](images/U002.jpg)
Attribution-NonCommercial-ShareAlike 2.5 License*/
body { margin: 0; padding: 0; text-align: center; background: #e6e6e6; ![images](images/U002.jpg)
...
**}**
**#top { height: 20px; margin-top: 20px; background: url(images/top.png) no-repeat;**
**}**
**#bottom { height: 20px; background: url(images/bottom.png) no-repeat;**
}` `header { width: 700px; height: 154px; margin: 0; margin-left:10px; ![images](images/U002.jpg)
border-bottom:10px white solid; background: url(images/bluepan.jpg);
}
#leftcol { margin: 0 10px; display:inline; /* fix IE double margin float bug */![images](images/U002.jpg)
float: left; width: 500px; text-align:left;
}
#mainContent {margin:0 0 0 10px; border:0 10px 0 10px white solid; width: 700px; ![images](images/U002.jpg)
...
`/*This css template is adapted from a template created by Andy Budd (www.andybudd.com) ![images](images/U002.jpg)
...
#leftcol { margin: 0 10px; display:inline; /* fix IE double margin float bug */![images](images/U002.jpg)
                float: left; width: 500px; text-align:left;
}` `#mainContent {margin:0; width: 700px; float: left; background-color:#aac9f6; ![images](images/U002.jpg)
...
![images](images/9781430242758_Fig08-24.jpg)
...
11.  对于阴影偏移，选择 1。
12.  点击文件![images](images/U001.jpg)添加文件。
