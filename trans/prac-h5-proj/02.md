...
[清单 2-3b](#list_2_3b) 将缩略图呈现为两列，并为展开的图像创建一个空间。
...
![images](img/square.jpg) **提示** Lightbox 是创建画廊的另一种方法。如果你相当熟练地使用 JavaScript，访问`[http://www.lokeshdhakar.com/projects/lightbox2/](http://www.lokeshdhakar.com/projects/lightbox2/)`你会发现一个演示，完整的代码和详细的说明。您还可以下载各种脚本。不幸的是，弹出图片覆盖了缩略图，但是提供了一些控件，使用户能够移动到下一个缩略图，就像幻灯片放映一样。按下 Escape 键，可以返回缩略图。
