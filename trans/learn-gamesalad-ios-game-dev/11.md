...
本节涵盖了配置门户上的所有必要操作。您将创建一个应用 ID，作为您游戏的唯一 ID。您还将使用您的分发证书(在第 1 章中创建)来签署您的应用。最后，您将创建用于在 GameSalad 中发布游戏的发行版配置文件。
...
在`itunesconnect.apple.com`连接到 iTunes Connect。点击图 11-5 中[所示的管理您的应用链接。](#fig_11_5)
...
下一个屏幕是您的应用的评级。根据[图 11-10](#fig_11_10) ，这些问题是不言自明的。
...
如果您在游戏中使用 Game Center，您需要启用 Game Center 以获取完成游戏配置所需的信息。在“新建应用摘要”页面中，单击“管理 Game Center”按钮。您将被引导至一个页面，按照图 11-15 中的[启用 Game Centre。单击启用按钮。](#fig_11_15)
...
返回 iTunes Connect 并在“管理您的应用”部分选择您的游戏。摘要页面应类似于图 11-30 中的[页面，状态为准备上传。](#fig_11_30)
...
打开应用加载器。如果这是您第一次使用它，您将被要求按照[图 11-32](#fig_11_32) 接受软件许可协议。
...
在应用加载器主屏幕中，根据[图 11-33](#fig_11_33) 选择交付您的应用。

![Image](img/9781430242789_Fig11-33.jpg)

**图 11-33。** *应用加载器主屏幕*

接下来，通过单击“选择您的应用”来选择您的应用单击下一步。然后，按照[图 11-34](#fig_11_34) 点击选择按钮，选择要上传的二进制文件。
...
恭喜你！！！！您收到了一封电子邮件，表明您的应用现在可以出售了([图 11-39](#fig_11_39) )。
