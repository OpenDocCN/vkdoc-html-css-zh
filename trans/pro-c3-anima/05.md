...
![image](images/sq.jpg) **注意**根据屏幕上的运动速度，如果大约每 50 毫秒显示一个新帧，动画序列就会平滑播放。遵循 CSS 的原则，动画模块不试图定义回放速率或每秒显示的帧数(FPS)。所有 CSS 动画都是由状态(*到*和*从* a 状态)或一个序列需要多长时间(之前的*时间和* a 状态之后的*时间)定义的。剩下的就交给浏览器或客户端了。您完全可以优化您的 CSS 声明，以减少浏览器的负载并创建更高效的动画，但是您不能“逐帧”创建您的序列(除了可能的步骤过渡，在[第 3 章](03.html)中讨论)，并且您不能定义帧速率。*
...
***[清单 5-3](#_list3) 。*** 混合了关键词和百分比值的关键帧序列
...
这种重复显然是在你为支持其他旧版本浏览器而写的时候积累起来的；第 10 章中讨论的一些工具可以简化和自动化这个过程。
...
组合这两个动画序列的绘制结果如[图 5-1](#Fig1) 所示。

![9781430247227_Fig05-01.jpg](images/9781430247227_Fig05-01.jpg)
...
![9781430247227_Fig05-02.jpg](images/9781430247227_Fig05-02.jpg)
...
![9781430247227_Fig05-03.jpg](images/9781430247227_Fig05-03.jpg)
...
![9781430247227_Fig05-04.jpg](images/9781430247227_Fig05-04.jpg)
...
***[清单 5-10](#_list10) 。*** CSS 使用挤压和拉伸动画原理制作一个无休止重复的弹跳球
