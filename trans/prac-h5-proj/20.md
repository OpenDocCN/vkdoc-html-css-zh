...
![imges](img/square.jpg) **提示**访问`[http://gs.statcounter.com](http://gs.statcounter.com)`时，选择条形图版本，清晰了解当前情况。选择折线图版本以查看趋势。另请参见`[http://marketshare.hitslink.com/browser-market-share.aspx?qprid=3](http://marketshare.hitslink.com/browser-market-share.aspx?qprid=3)`。
