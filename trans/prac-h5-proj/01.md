...
![images](images/square.jpg) **注意**更简单的 HTML5 DOCTYPE 可用于包含 XHTML 标记的页面，它将进行验证。事实上，可以完全忽略 XHTML5 DOCTYPE。HTML5 并不在乎你是否使用封闭标签(比如`<br />`)。本书中的例子不使用结束标记；但是，如果您一直使用 XHTML，您可能更喜欢继续使用结束标记——html 5 将接受任何一种方式。
...
![images](images/square.jpg) **注意**目前的 HTML5 和 XHTML5 验证器是`[http://validator.w3.org](http://validator.w3.org)`和`[http://html5.validator.nu](http://html5.validator.nu)`。这些仍然是实验性的，你应该知道它们可能会随着时间的推移而改变。
...
![images](images/square.jpg) **注意** HTML5 的属性不一定要用引号括起来，许多 MIME 类型现在可以在 HTML5 中省略——但是对于 XHTML5，可以保留引号和 MIME 类型。
...
![images](images/9781430242758_Fig01-01.jpg)
...
![images](images/square.jpg) **注意** CSS 假设元素是`*display:inline;*`。这需要改变。要确保语义标签在所有浏览器中都像块一样，请通过在链接的 CSS 表单中插入以下行来调整 display 属性。
...
![images](images/square.jpg) **注意**接下来三个例子中的导航菜单都是原始的；更复杂的菜单将在本章后面介绍。HTML5 翻转菜单在第 4 章的[中有完整的解释(有工作示例)。](04.html#ch4)

[图 1-2](#fig_1_2) 和 [1-3](#fig_1_3) 展示了语义标签的效果。

![images](images/9781430242758_Fig01-02.jpg)

***图 1-2。**在 IE 9、火狐、Safari、Opera、Chrome 中显示*

![images](images/9781430242758_Fig01-03.jpg)
...
![images](images/square.jpg) **提示**提示`[http://www.my-debugbar.com/wiki/IETester/HomePage](http://www.my-debugbar.com/wiki/IETester/HomePage)`。详见第 19 章。除了 IETester，还有其他工具可以用来测试您的页面是否支持旧版本的浏览器。你可以试试 Adobe BrowserLab，微软 Expression 的 SuperPreview，IE NetRenderer ( `[http://netrenderer.com](http://netrenderer.com)`)。
...
![images](images/square.jpg) **提示**参见雷米夏普在`[http://remysharp.com/2009/01/07//html5-enabling-script](http://remysharp.com/2009/01/07//html5-enabling-script)`的 B:log。参见布鲁斯·劳森和雷米·夏普的《T4 介绍 HTML5》。
...
![images](images/square.jpg) **注意** `html5.js`不是写成“htm 加 15”而是写成 htm 加小写 L 和数字五。

甚至 JavaScript 哑剧类型；`type="text/javascript"`可以从 HTML5 中省略。默认情况下，新浏览器识别 JavaScript 文件的结尾`*.js`,并应用适当的 MIME 类型。

![images](images/square.jpg) **注意**条件和脚本必须在`<head>`段中，放在任何一个样式表链接之后，如图[图 1-4](#fig_1_4) 所示。

![images](images/9781430242758_Fig01-04.jpg)
...
![images](images/9781430242758_Fig01-05.jpg)
...
article { float:left; **width:33%;** background-color:#FF9966; **margin:0 0 0 10px;** ![images](images/U002.jpg)
**padding:6px;**
}
footer { clear:both; background-color:#FF9966; text-align:center;
}
...
![images](images/9781430242758_Fig01-06.jpg)
...
<div id="content">
<article>
<strong>Article<br></strong>From a local newspaper:<p><strong>Are you ![images](images/U002.jpg)
illiterate?</strong><br>Write today for a <strong>Free</strong> course. ![images](images/U002.jpg)
...
<article>
<strong>Another Article</strong><br>Mark Twain said:&quot;Life is one ![images](images/U002.jpg)
...
header { width:780px; background-color:#FF9966; text-align:center; ![images](images/U002.jpg)
margin:5px auto 10px auto; padding:2px;
}
article { float:left; width:190px; margin:0 0 0 10px; padding:6px;
}
footer { clear:both; background-color:#FF9966; text-align:center; ![images](images/U002.jpg)
...
nav li a { display: block; color: white; font-weight: bold; ![images](images/U002.jpg)
...
![images](images/9781430242758_Fig01-07.jpg)
...
**   复制页面的样式表，并将其命名为类似于 *html5-style.css* 的名称。我已经将我的副本命名为`starter.css`，可以在 [http:// `www.apress.com`](http://www.apress.com) 的页面下载。*   在您打算转换的页面中查找逻辑块。此外，查看新标签的清单，看看如何调整页面以适应它们。我正在处理的页面没有独立的条目，因此我们不能使用`<article>` s。逻辑块最终将成为语义块。在本练习中，合适的模块如下:
    ...
    *T2`[http://remysharp.com/2009/01/07//html5-enabling-script](http://remysharp.com/2009/01/07//html5-enabling-script)`*
...
<img alt="Cottage interior" title="Cottage interior" height="225" ![images](images/U002.jpg)
src="images/cotdining300.jpg" width="300"><br>The superb interior ![images](images/U002.jpg)
...
<li class="btn"><a href="faqs.html" title="Frequently Asked Questions">Information</a> ![images](images/U002.jpg)
</li>
...
<img title="Devon countryside" alt="Devon countryside" src="images/devon398.jpg" ![images](images/U002.jpg)
...
***清单 1-7b。**修改后的 CSS 工作表* **为[图 1-7](#fig_1_7)***(html 5-style-2 . CSS)*
...
border-right:10px white solid; border-bottom:10px white solid; width: 904px; ![images](images/U002.jpg)
margin-top:10px; margin-left:auto; margin-right:auto; padding:8px; ![images](images/U002.jpg)
...
#midcol { margin-left:315px; margin-right:145px; margin-top:10px; ![images](images/U002.jpg)
vertical-align:top;
}
...
li.btn a { display: block; color: white; font-weight: bold; ![images](images/U002.jpg)
text-decoration: none; zoom:1;
}
/* specify mouse state styles */
/* mouseout (default) */
li.btn a { background:#559a55; color: white; border: 5px outset #559a55; ![images](images/U002.jpg)
padding-bottom:3px;
}
/* mouseover */
...
![images](images/square.jpg) **注意**语义标签并没有完全免除 *id* 和*类*标识符。一个 HTML5 页面可以有几篇文章，分别用它们自己的 *id* s 和*类来标识。*
...
![images](images/square.jpg) **注意**`<section>`元素被当作`display:inline;`。在当前的浏览器中，这可能最终会改变，但同时将`<section` >元素设置为`display:block;`。

### <抛开>的标签

标签将一段文本从主要内容中分离出来。它可以有边框和/或背景色，使其从周围的文本中突出出来。这意味着`<aside>`可以包含有趣的摘录来吸引用户阅读正文。一个带边框的`<aside>`如图[图 1-8](#fig_1_8) 所示。

![images](images/9781430242758_Fig01-08.jpg)
...
        <article>
        <b>The answer is all of them.</b> If you survey a group of computer ![images](images/U002.jpg)
         aficionados you will get very different answers…Internet Explorer.
                **<aside>**
                The great majority of ordinary folk are using IE because it came ![images](images/U002.jpg)
...
![images](images/9781430242758_Fig01-09.jpg)

***图 1-9。**标记标签可用于突出显示文本。*

![images](images/square.jpg) **提示**<标记>可以与搜索结合使用，也许可以使用斯图尔特·朗里奇的 *searchhi* 脚本，该脚本可以从`[http://www.kryogenix.org/code/browser/searchhi/](http://www.kryogenix.org/code/browser/searchhi/)`下载
...
<article>
<strong>The answer is all of them.</strong> If you survey a group of computer ![images](images/U002.jpg)
aficionados you will get very different answers compared with the general public’s ![images](images/U002.jpg)
answers.&nbsp; I worked as a freelance computer technician for over eleven years, ![images](images/U002.jpg)
During that period I never came across a single person who was using a browser other ![images](images/U002.jpg)
...
None had ever heard of Mozilla Firefox, although I did meet one person whose son had ![images](images/U002.jpg)
put Firefox on his computer,
he wanted me to remove it because he did not know what it was.
The great majority of ordinary folk are using <mark>IE</mark> because it came ![images](images/U002.jpg)
pre-installed with their computers. When reading magazine surveys, it would be ![images](images/U002.jpg)
safer to increase their survey figures for <mark>Internet Explorer.</mark> The ![images](images/U002.jpg)
results show that you should ensure that your web sites work in <mark>IE7</mark> ![images](images/U002.jpg)
and <mark>IE8</mark> because these are the most used (by default). It would be ![images](images/U002.jpg)
safe to predict that there will be a strong swing towards <mark>IE 9</mark> from ![images](images/U002.jpg)
2011.
</article>
</div>
</body>
...
![images](images/9781430242758_Fig01-10.jpg)
...
![images](images/square.jpg) **注意**即使 HTML5 内置了格式检查，机器人和罪犯仍然可以输入可疑的网址。因此，对于某些字段，您仍然需要防黑客表单处理程序的保护。
...
`[http://devfiles.myopera.com/articles/4582/html5-forms-example.html](http://devfiles.myopera.com/articles/4582/html5-forms-example.html)`。

这些表单在不同的浏览器中有不同的外观，但是它们都以相同的方式运行。歌剧中的出场如图[图 1-11](#fig_1_11) 、[图 1-12](#fig_1_12) 、[图 1-13](#fig_1_13) 所示。

![images](images/9781430242758_Fig01-11.jpg)
...
![images](images/9781430242758_Fig01-12.jpg)
...
![images](images/9781430242758_Fig01-13.jpg)
...
<input type="number" name="numberexample" id="numberexample" min="1" max="10" value="1" ![images](images/U002.jpg)
required>  (1-10)
</div>
<div>
...
step="0.1">
<output onforminput="value=rangeexample.value" for="rangeexample">1</output>m ![images](images/U002.jpg)
(in 10cm increments)
</div>
<div>
**<label for="deliverydate">Delivery date</label>**
<input type="date" name="deliverydate" id="deliverydate" min="2010-12-16" required> ![images](images/U002.jpg)
(minimum 16 December 2010)
<!-- with some server-side scripting we'd prefill the min attribute with today's ![images](images/U002.jpg)
date ... in this static example it's simply hardcoded -->
</div>
<div>
**<label for="timeexample">Time of delivery</label>**
<input type="time" name="timeexample" id="timeexample" step="1800" required> ![images](images/U002.jpg)
(in 30 min increments)
</div>
<div>` `**<label for="colorexample">Color of the item</label>**
<input type="color" name="colorexample" id="colorexample" value="#ed1c24"> ![images](images/U002.jpg)
(default red)
</div>
<input type="submit">
</form>
...
    <svg version="1.1" baseProfile="full" ![images](images/U002.jpg)
    xmlns=http://www.w3.org/2000/svg  width="100px" height="100px">![images](images/U002.jpg)
    <rect x="10" y="10" fill="red" width="100px" height="100px" />
    </svg>` ![images](images/9781430242758_Fig01-14.jpg)

***图 1-14。**一个 SVG 形象*

文件必须保存为*。* `svg`文件。我已经把它作为`mysvg.svg`保存在了伙伴网站上。

只需右击`mysvg.svg`并在浏览器中打开(但不是 Safari、IE 7 或 IE 8)就可以看到红色方块。双击文件不会打开它。Adobe Photoshop 和 GIMP (GNU 图像处理程序)可以导入和显示 SVG 图像。该文件不能被视为正常图像；比如这个不行，`<img="images/mysvg.svg">`。
...
![images](images/square.jpg) **注意**SVG 的 MIME 类型是`**type="image/svg+xml"**`。

使用 SVG 可以创建各种形状，如三角形、椭圆形、圆角矩形和圆形。我们这里只有展示 SVG 循环的空间。

![images](images/9781430242758_Fig01-15.jpg)
...
图 1-14 中[所示的彩色方块完全由文本构成；`.svg`文件只作为代码存在于页面上。如果 SVG 文件很大，最好保存为`.svg`文件，用`<object>`导入。否则页面将会充满难以理解的代码，使工作变得困难。](#fig_1_14)
...
![images](images/9781430242758_Fig01-16.jpg)

***图 1-16。**蝴蝶*

![images](images/9781430242758_Fig01-17.jpg)
...
![images](images/9781430242758_Fig01-18.jpg)
...
<text x="20" y="50" style="font-family:times new roman; font-size:36pt; ![images](images/U002.jpg)
...
<body>
<svg version="1.1" baseProfile="full" ![images](images/U002.jpg)
width="500px" height="60px"><text x="20" y="50" style="font-family:times new roman; ![images](images/U002.jpg)
font-size:36pt; font-weight:bold; letter-spacing:20px; stroke:black; ![images](images/U002.jpg)
...
![images](images/9781430242758_Fig01-19.jpg)

***图 1-19。**这可能是填满页面的一系列标题。为了清楚起见，仅示出了一个。*

接下来的[图 1-20](#fig_1_20) 显示了点击标题后的扩展文本。

![images](images/9781430242758_Fig01-20.jpg)
...
<p>The UK not for profit organization Raspberry Pi is hoping to sell<br> a computer for ![images](images/U002.jpg)
&pound;15 (or less if the take up is good).<br>It is no bigger than a USB connector, it ![images](images/U002.jpg)
has an ARM chipset, <br>a wi-fi chip, a version of the BASIC programming language <br>and ![images](images/U002.jpg)
it is preloaded with the Linux operating system. The primary purpose <br>for this ![images](images/U002.jpg)` `innovation is as a teaching tool for UK schools where children <br>are bored stiff with ![images](images/U002.jpg)
The current curriculum. You can read more about it at ![images](images/U002.jpg)
...
![images](images/square.jpg) **提示**如果您希望了解更多关于新 API 的信息，请尝试以下资源: *HTML5:启动并运行*，作者 Mark Pilgrim (O'Reilly Media，2010)；彼得·吕贝尔斯、布莱恩·艾伯斯和弗兰克·萨利姆的《专业 HTML5 编程》( Apress，2011)；
...
![images](images/square.jpg) **注**html 5<视频>和<音频>标签在[第 6 章](06.html#ch6)中有所涉及。*