...
![9781484204610_Fig06-03.jpg](../Images/image00427.jpeg)
...
![9781484204610_Fig06-04.jpg](../Images/image00428.jpeg)
...
[***清单 6-4***](#_list4) 。一个振荡器的增益由另一个振荡器控制
...
![9781484204610_Fig06-13.jpg](../Images/image00437.jpeg)
...
我们在[清单 6-5](#list5) 的例子中添加了第二个按钮，现在手动启动音频文件。下载音频文件后，离线上下文正在对其进行解码并开始呈现(当我们单击 start 按钮时)。在渲染例程中，我们保存解码后的`AudioBuffer`数据，以便在稍后阶段重新加载。就是这个`AudioBuffe` `r`数据，我们交给直播`AudioContext`回放。
...
[图 6-16](#Fig16) 显示了运行[清单 6-22](#list22) 的结果。

![9781484204610_Fig06-16.jpg](../Images/image00440.jpeg)

[图 6-16](#_Fig16) 。在 Web 音频 API 中呈现音频波形
